!(function (e) {
    ...
    new LazyLoad({ elements_selector: ".lazy" }),
        ...
        e(".carousel_4").owlCarousel({
            ...
            navText: ["<i class='arrow_left'></i>", "<i class='arrow_right'></i>"],
            nav: !1,
            responsive: { 0: { items: 1 }, 560: { items: 1 }, 768: { items: 2 }, 1230: { items: 3, nav: !0 } },
        }),
    ...
    e(window)
        ...
        e(".btn_play").magnificPopup({ type: "iframe", closeMarkup: '<button title="%title%" type="button" class="mfp-close" style="font-size:26px; margin-right:-10px;">&#215;</button>' }),
        ...
        e("#password, #password1, #password2").hidePassword("focus", { toggle: { className: "my-toggle" } }),
